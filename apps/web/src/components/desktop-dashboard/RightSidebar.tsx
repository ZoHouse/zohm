  ...
  return (
    <div className="flex flex-col w-[360px] flex-shrink-0" style={{ gap: DashboardSpacing.xl }}>
      ...
      >
        ...
        <div className="flex items-start" style={{ gap: DashboardSpacing.xl }}>
          <div className="flex flex-col" style={{ gap: DashboardSpacing.md }}>
            <div 
              className="border-2 border-solid overflow-hidden"
              style={{
                width: '80px',
                height: '80px',
            ...
            >
              <img 
                src="/dashboard-assets/image-6.png" 
                alt="Demo Day" 
          ...
          <div className="flex flex-col" style={{ gap: DashboardSpacing.md }}>
            ...
            >
              <img 
                src="/dashboard-assets/img-4761-3.png" 
                alt="Degen Lounge" 
                className="w-full h-full object-cover"
              />
            </div>
          ...
          <div className="flex flex-col" style={{ gap: DashboardSpacing.md }}>
            ...
            >
              <img 
                src="/dashboard-assets/image-240.png" 
                alt="Zo Collective" 
                className="w-full h-full object-cover"
              />
            </div>
        ...
        <div className="flex justify-center" style={{ gap: DashboardSpacing.sm }}>
          <div 
            className="rounded-full"
            style={{
              width: '8px',
              height: '8px',
              backgroundColor: DashboardColors.text.primary,
            }}
          />
          <div 
            className="rounded-full"
