...
import { DashboardColors, DashboardTypography, DashboardRadius } from '@/styles/dashboard-tokens';
...
const SocialPassport: React.FC<SocialPassportProps> = ({ profile, completion, className }) => {
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center pt-[40px]">
        ...
        <div className="relative w-[140px] h-[140px] flex items-center justify-center">
          ...
          {/* Avatar */}
          <div className="w-[120px] h-[120px] rounded-full overflow-hidden border-2 border-transparent">
            <img 
              src={avatar} 
              alt={name} 
              className="w-full h-full object-cover"
        ...
        {/* Text Container */}
        <div className="w-full p-6 pb-8 text-center flex flex-col gap-1">
