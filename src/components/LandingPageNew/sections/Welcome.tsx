  ...
  return (
    ...
    >
      ...
      <Flex col items="center" className="relative z-3">
        ...
        {/* Live Stats Badge */}
        <div className="flex items-center gap-3 px-6 py-3 mt-8 bg-white/10 backdrop-blur rounded-full border border-white/20">
          ...
          <span className="text-sm md:text-base text-white/90 font-medium">
            {stats.events} Events • {stats.nodes} Nodes • {stats.quests} Quests
          </span>
        </div>

        <Button className="mt-8 flex items-center" onClick={onEnterGame}>
          Enter Game of Life
        </Button>
      </Flex>
