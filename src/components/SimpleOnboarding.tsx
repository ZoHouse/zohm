      ...
      <div className="bg-black/40 backdrop-blur-md rounded-2xl shadow-2xl w-full max-w-5xl mx-auto p-6 sm:p-8 border border-white/20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-3 dropdown-container">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2.5 pl-10 bg-white/10 border border-white/30 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent backdrop-blur-sm"
              />
              <svg 
                ...
                <div className="absolute z-10 w-full mt-1 bg-black/90 backdrop-blur-md border border-white/30 rounded-lg shadow-lg max-h-48 overflow-y-auto">
                  {filteredCities.length > 0 ? filteredCities.map((c) => (
                    <button
                      ...
                      className="w-full px-4 py-2 text-left text-sm text-white hover:bg-white/20 transition-colors border-b border-white/10 last:border-b-0"
                    >
                      {c.name}
                    </button>
                  )) : (
            ...
            <button
              ...
              className="w-full px-3 py-1.5 text-xs bg-white/10 border border-white/30 rounded-lg hover:bg-white/20 transition-colors text-white"
            >
              📍 Use My Location
            </button>
            {errors.city && (
          ...
          <div className="space-y-3 dropdown-container">
            ...
            {errors.culture && (
              <p className="text-xs text-red-300">{errors.culture}</p>
            )}
          </div>
        </div>
